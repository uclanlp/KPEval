...
@gin.configurable
class RetrievalMetricV2(KeyphraseMetric):
    def __init__(self, corpus_src_file, corpus_tgt_file, query_file, 
        ...
        """
        super(RetrievalMetricV2, self).__init__()
    ...
    def score_corpus(self, all_preds, all_refs, all_inputs):
        ...
        # print out examples to ensure alignment
        # print(self.corpus_str_list_src[-1])
        # print(self.corpus_tokens_list_src[-1])
        # print(self.corpus_str_list_tgt[-1])
        # print(self.corpus_tokens_list_tgt[-1])
        # exit()
        ...
        if self.do_sparse_retrieval:
            ...
            for data_idx, (src_l, trg_l, pred_l) in \
                ...
                # print(cur_query)
                # print(bm25_hits)
                # print({k: v[-1] for k, v in score_dict.items() if 'sparse' in k})
